...
> 2026-09-14 변경: PR #895는 [일반 프리필 패킷 직접 소비만 유지](ST_GB10_PACKET_ONLY_20260914.md)한다.
> 아래 S/M/I 내용은 과거 설계다. compact KDA와 혼합 경로의 실행 코드는 제외했고,
> M3 서빙 확장은 종료했다. 과거 구현은 `3ac2b17f`와 측정별 동결 revision에 보존한다.
