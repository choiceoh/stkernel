...
ENV_KEYS = (
    [k for k in (
        ...
        "VLLM_GLM53_INDEXER_GATE_SPLITK",
        "VLLM_GLM53_PREP_FUSED", "VLLM_GLM53_ASYNC_DFLASH",
        "VLLM_DFLASH_PREP_WARMUP",
        "VLLM_GLM53_MK_PDL", "VLLM_GLM53_MK_KSR_OUT",
        "VLLM_GLM53_AR_PREFETCH", "VLLM_GLM53_AR_CONSUMER_PDL", "VLLM_GLM53_DFLASH_EARLY_FC",
        "VLLM_GLM53_DRAFTER_PREP", "VLLM_GLM53_INDEXER_DECODE_FUSED",
        "VLLM_GLM53_DRAFTER_CTX_KV_W4",
    ) if k in os.environ]
