...
# Local-head ownership tests use only existing bench code and stdlib fakes;
# their six additions retain that closure (34 focused idle tests passed).
