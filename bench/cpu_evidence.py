...
# ST screening cases still run only temporary repositories and fabricated
# bracket records. The snapshot assertion now also names the offline latency
# helper in engine/base; retain that file explicitly in the fleet closure.
# Boot lease preparation/edit fixtures use the same inert shell entrypoint,
# signed temporary receipts, and existing bench Supervisor; no new dependencies.
# FFN packet probe admission adds only a literal command/changed-byte rejection
# in those same temporary fixtures, with no new executable dependency.
# PR #1013 adds two single-lane floor cases (a configurable floor for a box of its
# own, its precedence and nonsense fallback, and the floor in the cache key). Purely
# additive -- 26 lines, 0 removed -- and they run the same in-process fakes, so the
# closure is unchanged and only the pin moves.
# Harness 46 (onepass's two named workloads) adds one field to `test_fleet_st_bracket.record` --
# `workload_profile`, which is what a record is now compared within. The fixture builder gains a
# keyword with a default and nothing else: no new import, no new call, the same in-process fakes.
# The pin moves; the closure does not.
FLEET_AUDIT = {'tests/test_fleet_admission.py': 'd452bec3a6ae34be36547174f956d27a4bfe72c341627dec400c470c20c7f3e0', 'tests/test_fleet_approval.py': 'dbeb320ac50fbc7e813fc231e602beddedb17cc6a785a8a895803ba3f463be29', 'tests/test_fleet_cache_explain.py': '911f1bf7bc4678384dbb38514254fda81ebfbf56e43c0e8e229de123fb689d45', 'tests/test_fleet_classify.py': '371547d98b361a13da2874a47b23cca830718ab5116bbee291bb576660cc17ba', 'tests/test_fleet_cleanup.py': '3ec7cba8da87eaac9a78df418c1201aafeda73150859d4de9bdf3958d7bfab93', 'tests/test_fleet_coalescing.py': '11a9d00fdff5856cae9490b155f24d56e79bd40cc5ee208204c85330729440ca', 'tests/test_fleet_experiments.py': '45ef7737021a901937f16558024c31cf9eefbfd4890acd2305342b90e9aecb4e', 'tests/test_fleet_feedback.py': 'f3495b30e2d83edbbe01737f824271dcf182253829e4bc605bf84dddd957560e', 'tests/test_fleet_handoff.py': '0c2c6614fe0a38db723e3cfc42285d9c373d39435f00f11b284485f4ed3e4d39', 'tests/test_fleet_history.py': '609b5eeeffe427f3ac7dc64f33c1addfe5d9e613cc15730ce2cdbf120854dcd8', 'tests/test_fleet_idle.py': 'faaeec11f696ee4dc41ea8c220ddd00f8e5a1495ec8cb8ebde5abab352e654f9', 'tests/test_fleet_inspect.py': '8fdf8f9613cade8587822dc8985d60167129a536c03049db18aa5f94277e21c4', 'tests/test_fleet_launch.py': 'd47e87c939e2ad6b523f5bc2cb7301418fa5f7fab047c5c03349e1c095c0ac63', 'tests/test_fleet_onepass.py': '05e704d99c2b2a7cab8486d5d568c1c8d0ce248f2b1fe100f838e332fdee45f7', 'tests/test_fleet_onepass_integration.py': '871e39ffc5766ed107e4a638a2de9703136128221854f22080b130b5988d4e06', 'tests/test_fleet_pace.py': '632143478dc61366cab22efc4b2f0767a0cd4fd6db51e683cc1ee98a8b5dba25', 'tests/test_fleet_pause.py': 'edb558450099c03f889456c86cc461e9ca0beaee9b3f5af2433cd88ad5bed546', 'tests/test_fleet_pending.py': '0c2cf8a389461e6a901bbdf0fbbcfe5b7590f8402442b396184f5b44e4431792', 'tests/test_fleet_prepare.py': '0f32db88388bfb2957a2e4e58b5f2f3c77c93bbbdb9ce0b008166ec6e7c2daa4', 'tests/test_fleet_recovery.py': 'b994b03e073637ea4c4e13838163701731853683bf180702c6b6676fd4809356', 'tests/test_fleet_retry.py': 'a2f1bef4bf260f2888e4574922ed4027a0b9c337cf98156f4851a82b990e4e59', 'tests/test_fleet_runtime.py': 'ce973514d6307256872c1c23ecf0bc9208d1750853bbe2b202fed19222c3c810', 'tests/test_fleet_single.py': '1c039e1bc60da1162d14dfe3b804afdb52675b43cffb5bbe57088b79428b3a5b', 'tests/test_fleet_source.py': '4700e7f4dc853bf48441a5efb13e278afd390e2dda6fed08ea00f841c6630c51', 'tests/test_fleet_st_bracket.py': '74b7ba8e5aced3cae3b03d827773c3efd943763028b54b05caf4fafcff121dd4', 'tests/test_fleet_validation.py': '5f0f8c89aee50950121995e79bf7dd9c7ab3d2a15a172bae975620146e45eba9', 'tests/test_fleet_waitwork.py': 'e02e694fb08d614ab57b0ea3b87305b585c35f7b546bb148b232e1560aa39fca'}
...
LOGIC_SOURCE_AUDIT = {'tests/test_logic.py': 'a85748e0dfd03134b77b84e0845f32c83b2cf8291a99642e9ff99b322e04cc36', 'tests/test_glm53_overlay_sync.py': 'bafa1e1e9ebcb964d36f08030f5bcd9309403b02dc2684f604c40a62b8c2563a', 'bench/cpu_checks.py': 'f61b906b52d1e288ac9c70fb286f3fffeedbd2337a324c82c13e713a94fd4efd', 'bench/cpu_unittest.py': 'd61adde7318ade385523c2a3aca9b404e5b4bbc5e363cffb6bf58656d12bfade'}
...
def identity(repo, spec, environment, memo=None):
    ...
    if (not contracts and '--test' not in args and suites == ['fleet'] and FLEET_AUDIT
        ...
        if fleet_closure:
            fleet_closure = fleet_closure | {'engine/base/latency_trace.py'}
            scope = 'audited-fleet'
