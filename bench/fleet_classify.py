...
GPU_PATTERN = r'ab-lever|start-glm53|start-st-glm53|deploy-overlays|run_mk_probe|run_megakernel_bench|run_engine_probe|run_engine_check|docker run|--gpus|onepass\.py|bracket\.py|draft_replay\.py|bench-dec|torch\.cuda|nvidia-smi|\.cu\b|cuda_'
