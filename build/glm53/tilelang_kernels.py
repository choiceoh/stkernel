...
# with one delta vs that file, ours (the 2026-08-31 mhc_onepass_tilelang
# kernel that once sat at the bottom -- the decode pair folded into one
# launch behind VLLM_GLM53_MHC_ONEPASS -- was sunset in 34차 §8: the
# megakernel's MK_SEG_MHC replaced the pair, RUNBOOK EXP-19):
#   1. (2026-09-04) the VLLM_GLM53_MHC_PASSES block below the imports: an
