...
OPTION_KEYS = ("top_p", "top_k", "seed", "presence_penalty", "frequency_penalty", "repetition_penalty",
               ...
               "reasoning_budget", "reasoning_end", "_host_stop", "_transient", "_warm")
...
def validate_options(options: dict, vocab: "int | None" = None) -> None:
    ...
    if "_warm" in options and type(options["_warm"]) is not bool:
        raise ValueError("the internal warm marker must be boolean")
    p = options.get("top_p")
