...
# The dense partitioners borrowed above call self._collapse_to_vmk();
# mirror the dense class's staticmethod onto this class so the borrow
# resolves. See this patch's script for the full rationale.
if not hasattr(MoEDynamicKernel, '_collapse_to_vmk'):
    MoEDynamicKernel._collapse_to_vmk = staticmethod(
        DenseGemmKernel._collapse_to_vmk
    )
