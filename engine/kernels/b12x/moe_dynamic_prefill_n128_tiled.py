...
Uses paired N128 FC1; FC2 reloads its shared fragments to avoid register spills.
The CPU compiler rejected all-four-slice register retention (912-byte stack).
