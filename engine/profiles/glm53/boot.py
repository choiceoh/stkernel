    ...
    try:
        ...
        with recorder.phase("runner"):
            ...
            if tier_dir:                                                                # D16: idle conversations park on NVMe, per rank
                ...
                # Byte-compatible historical states still contain the old
                # BF16 route sums. Neither conversations nor prefix snapshots
                # may reintroduce them after the long-prefill arithmetic repair.
                state_format = f"glm53-kda-{F.kda_state_dtype}-moe-fp32-v2"
