...
with SPEC_K=7 (operator change, 2026-09-13) -- so the checkpoint's MTP block (layer 45, fp8 experts) is
...
SPEC_K = 7                                                            # DFlash2 draft slots per decode step; operator 2026-09-13
