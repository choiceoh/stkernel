...
from engine.base.config import CacheConfig, VllmConfig
from engine.base.comm import get_tensor_model_parallel_world_size
from engine.base.instruments import init_logger
from engine.profiles.glm53.shims import LayerNorm
from engine.modules.norm import RMSNorm
from engine.modules.linear import ColumnParallelLinear, MergedColumnParallelLinear, ReplicatedLinear, RowParallelLinear
from engine.modules.linear import MLAModules
from engine.profiles.glm53.ours import MultiHeadLatentAttentionWrapper
from engine.modules.nvfp4_linear import QuantizationConfig
from engine.modules.rotary import RotaryEmbedding, get_rope
from engine.modules.sparse_indexer import SparseAttnIndexerKpool
from engine.modules.linear import DeepSeekV2FusedQkvAProjLinear
from engine.base.cache_spec import DeepseekV32IndexerCache
from engine.profiles.glm53.shims import yarn_get_mscale
from engine.profiles.glm53.shims import extract_layer_index
# DROP (generality this engine does not carry): vllm.model_executor.utils -> maybe_disable_graph_partition
from engine.modules.sparse_indexer import fwht128_quant_fp8
...
from engine.base.cache_spec import KpoolTailSpec, MLAAttentionSpec
...
class Indexer(nn.Module):
    ...
    def forward(
        ...
        # deneb fork (glm53_indexer_gate_splitk): split-K Triton for the small-M
        # decode shape (opt-in; cuBLAS picks a 2-block kernel here)
        weights = _glm53_head_gate(hidden_states, self._wp_fp32)
