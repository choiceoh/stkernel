...
from engine.base.config import VllmConfig
# DROP (generality this engine does not carry): vllm.config -> ParallelConfig
from engine.base.comm import get_pp_group, get_tensor_model_parallel_rank, get_tensor_model_parallel_world_size, tensor_model_parallel_all_gather
# DROP (generality this engine does not carry): vllm.distributed -> get_ep_group
from engine.base.step_meta import get_forward_context, is_forward_context_available
from engine.base.instruments import init_logger
from engine.profiles.glm53.shims import SiluAndMul, SiluAndMulWithClamp
from engine.modules.moe import FusedMoEFactory
from engine.profiles.glm53.shims import GateLinear, fused_moe_make_expert_params_mapping
# deneb fork: fused small-M gate for sm_121 (overlay/modules/moe_gate_sm121).
from engine.profiles.glm53.shims import Fp8HeadLogitsProcessor, decodable_vocab_size
from engine.profiles.glm53.shims import DenebGateLinear
from engine.modules.norm import RMSNorm
from engine.modules.linear import MergedColumnParallelLinear, RowParallelLinear
from engine.modules.logits import LogitsProcessor
from engine.profiles.glm53.shims import MambaStateCopyFunc, MambaStateCopyFuncCalculator
from engine.base.cache_spec import MambaStateDtypeCalculator, MambaStateShapeCalculator
from engine.modules.hyper_connection import MHCFusedPostPreOp, MHCPostOp, MHCPreOp, hc_contract, hc_expand
from engine.modules.nvfp4_linear import QuantizationConfig
from engine.profiles.glm53.shims import GroupShape, scaled_dequantize
from engine.modules.logits import ParallelLMHead, VocabParallelEmbedding
from engine.base.loader import default_weight_loader, maybe_remap_kv_scale_name
from engine.profiles.glm53.shims import _get_moe_router_dtype
# DROP (generality this engine does not carry): vllm.model_executor.models.glm4_1v -> Glm4vDummyInputsBuilder, Glm4vForConditionalGeneration
# DROP (generality this engine does not carry): vllm.model_executor.models.interfaces -> EagleModelMixin, HasInnerState, IsHybrid, MixtureOfExperts, SupportsEagle3, SupportsPP
from engine.base.loader import AutoWeightsLoader
from engine.profiles.glm53.shims import maybe_prefix
# DROP (generality this engine does not carry): vllm.model_executor.models.utils -> PPMissingLayer, init_vllm_registered_model, is_pp_missing_parameter, make_layers, sequence_parallel_chunk
# DROP (generality this engine does not carry): vllm.models.common.ops.sequence_parallel -> sp_all_gather, sp_reduce_scatter, sp_shard
# DROP (generality this engine does not carry): vllm.multimodal -> MULTIMODAL_REGISTRY
# DROP (generality this engine does not carry): vllm.platforms -> current_platform
# DROP (generality this engine does not carry): vllm.sequence -> IntermediateTensors
from engine.base.config import Glm5NextConfig
