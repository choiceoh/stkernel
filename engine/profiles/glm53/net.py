...
class Glm53Net:
    ...
    def _select_pools(self, q8, w_eff, keys, scales, ke, n_cand: int, k: int, *, out=None,
        ...
        Complete pools compete by score. Only the incomplete trailing pool is
        appended separately by pool_slots, matching the model's kpool policy.
        `seq_lens` and `pool` are retained for capture provenance."""
        rows = q8.shape[0]
