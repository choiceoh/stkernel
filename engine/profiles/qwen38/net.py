...
class Qwen38Net:
    ...
    def prepare_dense(self, store=None, *, consume_weights=False):
        ...
        # a decode step's head rows on one launch over deep_gemm's own FP8 inputs (dense/fp8_rows: 742-836 against
        # 949-1013 us a read of the rank's 159 MB, q38head-0919b)
