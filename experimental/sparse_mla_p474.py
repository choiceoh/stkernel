...
class DeepseekV4FlashMLAMetadataBuilder(
    ...
    def build(
        ...
        # deneb fork: port of upstream PR #47474 -- reuse the mapping the
        # compressor builder already materialized for this batch.
