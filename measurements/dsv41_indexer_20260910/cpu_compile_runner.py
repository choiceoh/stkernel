#!/usr/bin/env python3
"""Normal fleet CPU payload: compile the compact indexer without GPU devices.
...
INPUTS = (
    ...
    "probes/dsv41_indexer_diff.py",
    "tests/test_dsv41_reference_adapter.py",
    "tests/test_dsv41_indexer_contracts.py",
    "measurements/dsv41_indexer_20260910/cpu_compile_runner.py",
)
...
def main():
    ...
    name = "dsv41-indexer-cpu-" + str(os.getpid())
