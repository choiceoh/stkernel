...
output='/home/choiceoh/dsv41-mhc-cpu2-evidence'
session='dsv41mhccpu0910v2'
...
command=['env','REPO='+source,'bash',source+'/bench/fleet.sh','run','--cpu',session,'10','DSV4.1 H5120 MHC full-TU AOT; no GPU devices','--','ssh','-o','BatchMode=yes','-o','ConnectTimeout=8','choiceoh@10.10.10.3',shlex.join(worker)]
metadata=Path('/tmp/dsv41-mhc-cpu2-execution.json'); log=Path('/tmp/dsv41-mhc-cpu2.log')
...
for host in (None,'choiceoh@10.10.10.3'):
