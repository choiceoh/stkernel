#!/usr/bin/env python3
"""Normal fleet CPU payload: compile packed-KV sparse attention without GPU devices.
...
INPUTS = (
    ...
    "overlay/modules/dsv41_model/dsv41_packed_kv.py",
    "overlay/modules/dsv41_model/dsv41_packed_kv_triton.py",
    "overlay/modules/dsv41_model/dsv41_packed_kv_reference_adapter.py",
    "probes/dsv41_packed_kv_diff.py",
    "tests/test_dsv41_packed_kv.py",
    "tests/test_dsv41_packed_kv_reference_adapter.py",
    "measurements/dsv41_packed_kv_20260910/cpu_compile_runner.py",
)
...
from dsv41_packed_kv_triton import offline_compile
...
def main():
    ...
    name = "dsv41-packed-kv-cpu-" + str(os.getpid())
