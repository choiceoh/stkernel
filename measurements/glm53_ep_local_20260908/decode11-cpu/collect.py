#!/usr/bin/env python3
"""Read-only collection of the already completed CPU11 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = 'c7dec80a0f73d4a2b683ce2c4813978938694095'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-11'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-11/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-11'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-11/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-11')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-11')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-11')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU11',
