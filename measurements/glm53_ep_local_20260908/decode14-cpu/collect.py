#!/usr/bin/env python3
"""Read-only collection of the already completed CPU14 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = 'c3696a76c6674ad38e01967fa587b8d31a6d121e'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-14'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-14/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-14'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-14/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-14')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-14')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-14')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU14',
