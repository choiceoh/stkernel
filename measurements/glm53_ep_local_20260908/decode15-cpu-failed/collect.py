#!/usr/bin/env python3
"""Read-only collection of the already completed CPU15 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = '71c407bbab59004a9a865acc17f3d2b5c48013c8'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-15'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-15/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-15'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-15/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-15')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-15')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-15')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU15',
