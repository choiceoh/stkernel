#!/usr/bin/env python3
"""Read-only collection of the already completed CPU16 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = '014ddde8919f24f94f0aee1730c09efb0b04088b'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-16'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-16/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-16'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-16/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-16')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-16')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-16')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU16',
