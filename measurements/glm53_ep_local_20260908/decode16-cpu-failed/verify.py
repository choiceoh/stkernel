#!/usr/bin/env python3
"""Reconcile archived CPU16 bytes and receipts without importing GPU modules."""
import hashlib
import itertools
import json
...
def main():
    ...
    assert submission['revision'] == '014ddde8919f24f94f0aee1730c09efb0b04088b'
    ...
    assert 'UNSUP_EARLY_EXIT' in result['error']
    ...
    report = dict(verdict='PASS', scope='CPU16 archive integrity only; no new tests or GPU execution',
