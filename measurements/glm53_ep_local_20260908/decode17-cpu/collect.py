#!/usr/bin/env python3
"""Read-only collection of the already completed CPU17 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = '0331579f4b16b8b811f2ca7e5099f8f461507c67'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-17'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-17/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-17'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-17/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-17')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-17')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-17')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU17',
