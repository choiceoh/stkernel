#!/usr/bin/env python3
"""Read-only collection of the already completed CPU18 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = 'ce7f222b0ae86124ccd177cfcf10975e411c6979'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-18'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-18/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-18'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-18/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-18')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-18')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-18')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU18',
