#!/usr/bin/env python3
"""Reconcile archived CPU18 bytes and receipts without importing GPU modules."""
import hashlib
import itertools
import json
...
def main():
    ...
    assert submission['revision'] == 'ce7f222b0ae86124ccd177cfcf10975e411c6979'
    ...
    assert 'TYPE_UNSTABLE_JOIN' in result['error']
    ...
    report = dict(verdict='PASS', scope='CPU18 archive integrity only; no new tests or GPU execution',
