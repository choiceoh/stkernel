#!/usr/bin/env python3
"""Read-only collection of the already completed CPU19 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = 'cd293e19c146bd52c3419b064af209b57b2555d9'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-19'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-19/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-19'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-19/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-19')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-19')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-19')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU19',
