#!/usr/bin/env python3
"""Read-only collection of the already completed CPU20 receipt; never runs tests."""
import base64
import hashlib
import io
import json
...
REVISION = '82d81d65b6a74e09abd9be0a8f05508e4855f6f1'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-20'
WORKER = 'choiceoh@10.10.10.1'
EVIDENCE = '/home/choiceoh/glm53-ep-cpu-0909-20/evidence'
JOB = '/tmp/glm53-ep-decode-cpu-0909-20'
...
root=pathlib.Path('/home/choiceoh/glm53-ep-cpu-0909-20/evidence')
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-20')
...
source=pathlib.Path('/home/choiceoh/stkernel-ep-onepass-0909-20')
job=pathlib.Path('/tmp/glm53-ep-decode-cpu-0909-20')
def git(*args):return subprocess.check_output(['git','-C',str(source),*args],text=True).strip()
files={}
...
def main():
    ...
    capture = dict(schema=1, scope='read-only archive of completed CPU20',
