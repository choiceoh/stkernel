...
def command(revision):
    return ['bash','/home/choiceoh/stkernel-ep-local-scheduler-0909/bench/fleet.sh','run','--cpu','eplocalcpu0908v17head','6',
...
need(submission['revision']==C['revision'] and submission['source']==str(source)
     and submission['scheduler']=='/home/choiceoh/stkernel-ep-local-scheduler-0909' and submission['command']==C['command'], 'CPU17 normal command/source differs')
