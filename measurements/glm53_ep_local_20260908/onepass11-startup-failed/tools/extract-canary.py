...
root=Path('/tmp/glm53-onepass11-streams');out=Path('/tmp/glm53-onepass11-canary');out.mkdir(exist_ok=True)
result={}
...
source=Path('/Users/ost/.worktrees/stkernel2/glm53-prefill-moe-pipeline-20260908/measurements/glm53_ep_local_20260908/decode11-cpu/result.json')
if source.exists():
 x=json.loads(source.read_text());Path('/tmp/glm53-onepass11-mounted-hashes.json').write_text(json.dumps(x['mounted_sources'],sort_keys=True,indent=2)+'\n')
