...
TICKET='178892234520953'
OWNER_PID='20953'

IMAGE = 'sha256:a3dd4c0f6cbb053097d65d10cd8ff8f6ae0cb9115cf0ff142e1cafe124c09211'
JOB = '/tmp/glm53-ep-onepass-0909-20'
SOURCE = '/home/choiceoh/stkernel-ep-onepass-0909-20'
NODE = r'''
...
def current_arm_event(session, ticket, owner_pid):
    ...
    expected=['EPONEPASS20'+arm for arm in ('A0','B1','A','B2','B3')]
    ...
    return dict(arm=names[-1].removeprefix('EPONEPASS20'),started_at=born.timestamp(),
...
def main():
    ...
    if args.session != 'eplocalonepass0909v20': p.error('wrong onepass20 session')
    ...
    if args.revision!=REV or not re.fullmatch('[a-f0-9]{40}',REV) or not TICKET.isdecimal() or not OWNER_PID.isdecimal() or int(OWNER_PID)<=0:
        p.error('bind actual onepass20 revision, ticket and owner PID before capture')
    os.umask(0o077)
    local=Path('/tmp')/('glm53-onepass20-live-'+label)
