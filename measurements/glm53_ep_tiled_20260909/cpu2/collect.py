#!/usr/bin/env python3
"""Read-only collection of the completed eptiledcpu0909v2 worker evidence."""
...
SOURCE='/home/choiceoh/stkernel-ep-tiled-0909-sf6'
EVIDENCE='/home/choiceoh/glm53-ep-tiled-cpu2-evidence'
...
for source,dest in [('/tmp/glm53-ep-tiled-cpu2-submission.json','submission.json'),('/tmp/glm53-ep-tiled-cpu2-fleet.log','fleet.log')]:shutil.copyfile(source,ROOT/dest)
