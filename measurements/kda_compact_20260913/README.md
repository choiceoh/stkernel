...
The first preparation attempt did not obtain a reservation because the candidate needed recent main changes. The branch was then rebased. The rerun uses session `st-kda-compact0913v2`, output `/cache/kda-compact0913v2.json`, and the image ID above. No other session's reservation is interrupted.
