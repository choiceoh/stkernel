...
modules = "test_engine_mixed_experts test_engine_mixed_completion test_engine_mixed_tickets test_fleet_onepass test_engine_mixed_plan test_engine_mixed_shared test_engine_ffn_packets test_engine_compact_serving test_engine_execution_plans test_engine_graph_contracts test_fleet_onepass_integration".split()
