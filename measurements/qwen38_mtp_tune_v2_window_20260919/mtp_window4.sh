#!/usr/bin/env bash
# The MTP campaign's fourth window (2026-09-19). The operator asked for ~1.5M positions of better text ("150만개로 하고
...
set -uo pipefail
OWNER="session/q38mtp-tune4-0919"
...
NOTE="operator window: MTP head -- the v2 data (1.5M positions, greedy-heavy mix), a fourth training, T=1 block verification"
...
databoot data3a "$OUT/boot_a.jsonl" "$OUT/raw_a.jsonl"         # the synthetic greedy conversations, the synthetic documents
