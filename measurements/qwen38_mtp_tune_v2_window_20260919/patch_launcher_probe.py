"""Window 5 only (operator 2026-09-19: "경합일어나도 상관없으니까 ... 같이하던가"): the measurement tree's launcher leaves
the single-GPU lane's st-probe-* containers out of its busy check, so a boot proceeds beside a lane probe on srv4.
A local edit of ~/st-worktrees/q38mtp-w4 -- never committed."""
from pathlib import Path

p = Path.home() / "st-worktrees/q38mtp-w4/launchers/start-st-qwen38.sh"
s = p.read_text()
