...
name=st-probe-cublas-producer-0917
...
run probes/engine_cublaslt_producer_check.py --gpu --packed-weight /work/packs/7e3c089b56122e41d05b7fcfc7163749d4f5a6eaa8f4186e2199fc71762d394e.pt --output /out/producer-final.json >"$root/out/producer-final.log" 2>&1
