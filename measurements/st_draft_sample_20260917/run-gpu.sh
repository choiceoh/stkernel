...
name=st-probe-draft-sample-0917
...
run probes/engine_draft_sample_check.py --gpu --output /out/draft-sample.json --baseline-drafter /out/draft-sample-baseline.py >"$root/out/draft-sample.log" 2>&1
