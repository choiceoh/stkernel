...
The matched control is `4de8c56fbbbb880358f25ee8818246163d9792d8` and the
candidate is `522cf7779e39b9b18b40f0722933d6aa1b22541a`. They differ only in
...
`consumer.patch` records this difference. Both include main `139c5fa5`.
...
before the pair are CPU-test isolation and documentation only. The focused
...
The full consumer tickets are `fixedk-next-consumer-b-0917` and
`fixedk-next-consumer-a-0917`, using the same controller from the control
...
Consumer trials and the final adoption decision are pending.
