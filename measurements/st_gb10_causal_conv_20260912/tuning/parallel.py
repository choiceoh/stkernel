...
from candidates import causal_conv1d_single,_single_conv_parallel as _single_conv
...
for t in (1,2,3,6,8,9,24,64,256,1024,4096,6912):
 ...
 expected=old(x,w,s)
 rows=[]
 for bc,nw,bt in ((64,4,4),(128,4,4),(128,4,8),(256,4,4),(64,1,1),(128,4,1),(256,4,1),(128,4,16)):
