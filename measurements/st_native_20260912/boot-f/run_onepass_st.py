...
assert '--kv-gib 16' in ' '.join(container['Config']['Cmd'])
assert container['Config']['Image']=='st-engine:perf-f4d7-f'
runtime=json.loads(subprocess.check_output(['docker','exec','st-glm53','cat','/opt/st/runtime-manifest.json'],text=True))
assert runtime['engine_source_sha256']=='e24ea2a1152984f4b11168bcc99c0ab7fb5a4815f9e94848107711284ef193c4'
