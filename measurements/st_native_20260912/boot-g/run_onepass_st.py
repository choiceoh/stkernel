...
assert container['Config']['Image']=='st-engine:perf-f4d7-g'
runtime=json.loads(subprocess.check_output(['docker','exec','st-glm53','cat','/opt/st/runtime-manifest.json'],text=True))
assert runtime['engine_source_sha256']=='0abb87ae741ee2843dc54ef16479c404478f28ff249cee346856eeb1f3b7a331'
