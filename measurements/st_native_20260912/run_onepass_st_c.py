...
assert container['Config']['Image']=='st-engine:perf-f4d7-c'
runtime=json.loads(subprocess.check_output(['docker','exec','st-glm53','cat','/opt/st/runtime-manifest.json'],text=True))
assert runtime['engine_source_sha256']=='61b590241f6a1ebc76f46011f8f8a161779d1e8a37bb1998e5b2b466af6210fd'
