...
assert container['Config']['Image']=='st-engine:perf-f4d7-e'
runtime=json.loads(subprocess.check_output(['docker','exec','st-glm53','cat','/opt/st/runtime-manifest.json'],text=True))
assert runtime['engine_source_sha256']=='af86a057c318a0e6ab6bdbd195e816ab9f31c68fed9c9cf28c8f37f8404104d3'
