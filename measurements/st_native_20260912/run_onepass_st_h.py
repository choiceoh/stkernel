...
assert '--kv-gib 12' in ' '.join(container['Config']['Cmd'])
assert container['Config']['Image']=='st-engine:perf-f4d7-h'
runtime=json.loads(subprocess.check_output(['docker','exec','st-glm53','cat','/opt/st/runtime-manifest.json'],text=True))
assert runtime['engine_source_sha256']=='de14e0d8fc16cac0fff176cf743425baaf47e94cda29ca29f01c1a19be2e3245'
