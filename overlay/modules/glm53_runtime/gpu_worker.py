...
class Worker(WorkerBase):
    ...
    def determine_available_memory(self) -> int:
        ...
        if (
            ...
            # GLM's launcher already reserves graph headroom in GMU when the
            # estimator is disabled. Avoid its throwaway KV allocation and
            # dry captures when their result will not be applied. Keep the
            # real model/MM profile above and compile/capture/warmup below.
            skip_unused_estimate = (
                os.environ.get("VLLM_GLM53_SKIP_UNUSED_GRAPH_PROFILE", "0") == "1"
            ...
            if skip_unused_estimate:
                logger.info(
                    "[glm53-graph-profile] skipped unused estimate rank=%d; "
