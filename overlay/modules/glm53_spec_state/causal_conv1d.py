...
def _causal_conv1d_update_kernel(
    ...
    if IS_SPEC_DECODING:
        ...
        # - and so on.
        # deneb fork (vLLM #51508): num_accepted_tokens is 0 for a stale row
        # whose sampled tokens were discarded, so the raw offset would be -1.
        # This one usually faults first among the spec-decode state consumers.
