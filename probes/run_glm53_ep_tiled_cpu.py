...
from glm53_ep_tiled_compile import (source_receipt, STATIC_ROWS, DYNAMIC_ROWS,
    ...
    opt_shared_capacity, validate_q1_pair_layout)
    ...
    for kind,rows in groups:
        ...
        for rows_count,passed in zip(rows,passes):
            ...
            if kind == 'opt_static':
                ...
                assert 'register_layout' not in passed
                assert passed['q1_pair_layout'] == validate_q1_pair_layout(
                    passed['q1_pair_layout'], fast_math=passed['cache_key'][6])
