"""Keep route-cache publication intact while bounding FP32 accumulator zeroing."""
import ast
import copy
import hashlib
...
class PrefillRouteCacheTests(unittest.TestCase):
    def test_complete_route_producer_preserves_the_fp32_q0_publication_contract(self):
    ...
    def test_zeroing_covers_fp32_accumulators_without_crossing_the_last_byte(self):
